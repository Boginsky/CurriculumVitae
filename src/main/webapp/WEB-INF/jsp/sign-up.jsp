    ...
    <div class="panel-body">
        ...
        <form:form action="./sign-up" commandName="profileForm" method="post">
            ...
            <div class="form-group ${hasError ? 'has-error has-feedback' : ''}">
                ...
                <form:input path="firstName" id="firstName" cssClass="form-control" placeholder="Example: Kirill" required="required"/>
            ...
            <div class="form-group ${hasError ? 'has-error has-feedback' : ''}">
                ...
                <form:input path="lastName" id="lastName" cssClass="form-control" placeholder="Example: Boginsky" required="required"/>
