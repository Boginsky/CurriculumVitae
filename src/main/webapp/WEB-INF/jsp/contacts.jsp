...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <form:form commandName="contactsForm" action="./contacts" cssClass="form-horizontal data-form">
            <sec:csrfInput/>
            <div class="row">
                <div class="col-sm-7">
                    ...
                    <div class="form-group ${hasError ? 'has-error' : ''}">
                        ...
                        <div class="col-sm-8">
                            <form:input path="skype" class="form-control" id="inputSkype" placeholder="Example: boginsky-kirill" />
            ...
            <div class="row">
                <div class="col-sm-7">
                    ...
                    <div class="form-group ${hasError ? 'has-error' : ''}">
                        ...
                        <div class="col-sm-8">
                            <form:input path="vkontakte" class="form-control" id="inputVkontakte" placeholder="Example: https://vk.com/boginsky-kirill" />
                    ...
                    <div class="form-group ${hasError ? 'has-error' : ''}">
                        ...
                        <div class="col-sm-8">
                            <form:input path="facebook" class="form-control" id="inputFacebook" placeholder="Example: https://facebook.com/boginsky-kirill" />
                    ...
                    <div class="form-group ${hasError ? 'has-error' : ''}">
                        ...
                        <div class="col-sm-8">
                            <form:input path="linkedin" class="form-control" id="inputLinkedin" placeholder="Example: https://linkedin.com/boginsky-kirill" />
                    ...
                    <div class="form-group ${hasError ? 'has-error' : ''}">
                        ...
                        <div class="col-sm-8">
                            <form:input path="github" class="form-control" id="inputGithub" placeholder="Example: https://github.com/boginsky-kirill" />
                    ...
                    <div class="form-group ${hasError ? 'has-error' : ''}">
                        ...
                        <div class="col-sm-8">
                            <form:input path="stackoverflow" class="form-control" id="inputStackoverflow" placeholder="Example: https://stackoverflow.com/boginsky-kirill" />
