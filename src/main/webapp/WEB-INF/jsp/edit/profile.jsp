...
<div class="panel panel-default edit-profile">
    <div class="panel-body">
        ...
        <c:if test="${profileForm.completed != true}">
            <h1 class="text">*После заполнения полей данной страницы регистрация будет завершена.</h1>
        </c:if>
        <resume:form-display-error-if-invalid formName="contactsForm" />
        <form:form commandName="profileForm" action="./edit?${_csrf.parameterName}=${_csrf.token}" method="post" cssClass="form-horizontal data-form">
            <form:hidden path="firstName"/>
            <form:hidden path="lastName"/>

            <resume:form-has-error path="largePhoto" />
            <div class="form-group ${hasError ? 'has-error' : ''}">
                <label for="inputPhoto" class="col-sm-2 control-label">Фото*</label>
                <div class="col-sm-5">
                    <c:if test="${profileForm.largePhoto == null}">
                        <img id="largePhoto" src="./static/image/user-not-found.png" class="edit-photo" />
                    </c:if>
                    <c:if test="${profileForm.largePhoto != null}">
                        <img id="largePhoto" src="${profileForm.profilePhoto}" class="edit-photo" />
                    </c:if>
                    <br/>
                    <br/>
                    <form:input path="largePhoto" class="form-control datepicker" id="inputPhoto" placeholder="Example: https://avatars......" required="required" />
                ...
                <div class="col-sm-5 help-block">
                    <blockquote>
                        ...
                        4. Вставьте URL вашей фотографии <br />
                    </blockquote>
                </div>
            </div>
            ...
            <div class="form-group ${hasError ? 'has-error' : ''}">
                ...
                <div class="col-sm-5">
                    <form:input path="country" class="form-control" id="inputCountry" placeholder="Example: Belarus" required="required" />
            ...
            <div class="form-group ${hasError ? 'has-error' : ''}">
                ...
                <div class="col-sm-5">
                    <form:input path="city" class="form-control" id="inputCity" placeholder="Example: Minsk" required="required" />
            ...
            <div class="form-group ${hasError ? 'has-error' : ''}">
                ...
                <div class="col-sm-5">
                    <form:input path="email" class="form-control" id="inputEmail" placeholder="Example: boginsky.kirill@gmail.com" required="required" />
